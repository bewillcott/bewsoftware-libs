 ...
 * <ul>
 * <li>{@linkplain #IniProperty(int, Property) IniProperty(id, property)}</li>
 * <li>{@linkplain #IniProperty(int, String, Object) IniProperty(id, key, value)}</li>
 * <li>{@linkplain #IniProperty(int, String, Object, String) IniProperty(id, key, value, comment)}</li>
 * </ul>
...
public sealed class IniProperty<V> extends Property<String, V> permits MutableIniProperty
{
     ...
     * @since 3.1.0
     */
    public <T extends Property<String, V>> IniProperty(final T property)
    {
        super(property);
    }
     ...
     * @since 3.1.0
     */
    public IniProperty(final String key, final V value)
    {
        super(key, value);
    }
     ...
     * @since 3.1.0
     */
    public IniProperty(final String key, final V value, final String comment)
    {
     ...
     * @since 3.1.0
     */
    public <T extends Property<String, V>> IniProperty(final int id, final T property)
    {
        super(id, property);
    }
     ...
     * @since 3.1.0
     */
    public IniProperty(final int id, final String key, final V value)
    {
        super(id, key, value);
    }
     ...
     * @since 3.1.0
     */
    public IniProperty(final int id, final String key, final V value, final String comment)
    {
